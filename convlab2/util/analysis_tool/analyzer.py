        ...
        for j in tqdm(range(total_dialog), desc="dialogue"):
            ...
            if j >= 0:
                for i in range(15):
                    ...
                    print('sys:', sess.user_agent.sys_observation, file=flog)
                    try:
                        print('user:', sess.user_agent.natural_language, file=flog)
                    except:
                        print(1)

                    user_responses.append(sess.user_agent.natural_language)
            ...
            suc = sess.evaluator.task_success()
            if suc != 1:
                print(0)
